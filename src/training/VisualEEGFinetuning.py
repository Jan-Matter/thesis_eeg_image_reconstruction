...
class VisualEEGEncoderTraining:
...
if __name__ == '__main__':
    training_conf_path = Path(os.getenv("CONFIG_FOLDER")) / "training" / "eeg_to_latent_image_training.yaml"
    ...
    training_conf["model_save_path"] = os.getenv("MODEL_FOLDER") + f"/eeg_channel_net_visual_v1.pt"
    training_conf["losses_save_path"] = os.getenv("OUTPUT_FOLDER") + f"/losses/eeg_channel_net_visual_v1.npy"
