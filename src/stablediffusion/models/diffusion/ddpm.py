...
from stablediffusion.util import log_txt_as_img, exists, default, ismap, isimage, mean_flat, count_params, instantiate_from_config
from stablediffusion.modules.ema import LitEma
from stablediffusion.modules.distributions.distributions import normal_kl, DiagonalGaussianDistribution
from stablediffusion.models.autoencoder import IdentityFirstStage, AutoencoderKL
from stablediffusion.modules.diffusionmodules.util import make_beta_schedule, extract_into_tensor, noise_like
from stablediffusion.models.diffusion.ddim import DDIMSampler
...
class LatentDiffusion(DDPM):
    ...
    def instantiate_cond_stage(self, config):
        if not self.cond_stage_trainable:
            ...
            model = instantiate_from_config(cn_log_steponfig)
