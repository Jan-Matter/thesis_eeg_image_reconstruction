...
class BackgroundColorEEGEncoderTrainingDataset(Dataset):
    ...
    def __init__(self,
        ...
        self.__color_class_map = {
            ...
            'brown': torch.tensor([0, 0, 0, 1]),
        }
        self.__sampling_freq = sampling_freq
        self.__cache_folder = Path('data/classification_cache/backgroundcolor_cache')
    ...
    def __getitem__(self, idx):
        ...
        if cache_path.exists():
            ...
            img = img_data['img']
            background_img = self.__extract_background_image(img)
            color, intensity = self.__extract_predominant_color_from_image(background_img)
...
if __name__ == '__main__':
    ...
    dataset = BackgroundColorEEGEncoderTrainingDataset(
